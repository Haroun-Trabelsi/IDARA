...
const RegisterStaticPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      alert('Registration successful! (Static mode)');
    }, 2000);
  };
  ...
  const isSubmitDisabled = !formData.name || !formData.surname || !formData.organizationName || !formData.email || !formData.password || !formData.teamSize || !formData.region;
...
export default RegisterStaticPage;