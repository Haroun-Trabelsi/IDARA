...
const Header: React.FC<Props> = () => {
  ...
  return (
    <AppBar className='header' position='static'>
      <img 
        src="https://www.visionage-vfx.com/wp-content/uploads/elementor/thumbs/logo-vision-age-vfx-company-tunisia_white-qr59xyrxys1aimzushsyf2zn091u6egedmpvqp9gke.png" 
        title="logo-vision-age-vfx-company-tunisia" 
        alt="logo-vision-age-vfx-company-tunisia" 
        loading="lazy" 
