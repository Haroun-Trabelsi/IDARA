...
router.get('/results_by_task', checkBearerToken, async (req, res, next) => {
  try {
    // You can now use account.apiKey, account.username, account.companyFtrackLink dynamically here if needed
